  ...
  get 'paypal_receipt' do
    ...
    if pdt.success
      if pdt.payment_status == 'Completed'
        ...
        eml.content = view(:payment_email,
        ...
        view :paypal_receipt
        view.msg = "Thank you for your payment. Your transaction has been completed, and a receipt for your purchase has been emailed to you. You may log into your account at www.paypal.com/us to view details of this transaction."
      else
